...
import { userTableColumns } from '@/code/data/features/user/user-const.ts';
...
<template>
  <TableWrapper>
    ...
    <template #tablePanel>
      ...
      <div v-if="!isLoading">
        <TablePage v-model="selRecord" :columns="userTableColumns" :data="table.entries" empty="admin.user.table.empty"/>
      </div>
    </template>
