...
/** Info about components for slideshow. */
...
<template>
  ...
  <ul>
    ...
    <li v-html="t('homeArea.components.Table')"></li>
    <li v-html="t('homeArea.components.SpinnerTorus')"></li>
  </ul>
</template>
