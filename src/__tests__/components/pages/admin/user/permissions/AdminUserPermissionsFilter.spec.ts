...
const defaultForm: UserPermissionTableFilterForm = {
  userId: -1,
...
/** Tests of AdminUserPermissionsFilter component. */
describe('AdminUserPermissionsFilter', () => {
  // //////////////////////////////////////////////////////////////////////////
  // Rendering
  ...
  describe('rendering', () => {
    it('renders the filter heading', () => {
      ...
      expect(heading.text()).toBe('🔍 User permission filter');
    });
